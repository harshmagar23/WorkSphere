...
<title>Server Error | WorkSphere</title>
...
<main class="shell">
    <section class="copy">
        ...
        <h1>Something broke <em>500</em></h1>

        <p>The server could not complete this request. This may happen because of a database connection issue, missing record, or unexpected backend error.</p>
    ...
    <section class="card">
        ...
        <div class="info-grid">
            <div class="info">
                ...
                The server could not complete this request. This may happen because of a database connection issue, missing record, or unexpected backend error.
            </div>
