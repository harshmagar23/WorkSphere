...
<title>Freelancer Login - WorkSphere</title>
...
::selection{background:var(--pri);color:#07080D}a{color:inherit}.wrap{max-width:var(--max);margin:0 auto;padding:0 32px}
...
.logo{font-family:var(--h);font-size:20px;font-weight:800;text-decoration:none;letter-spacing:-0.75px}.logo .s{color:var(--pri)}
...
.auth-grid{position:relative;z-index:1;display:grid;grid-template-columns:1.08fr .92fr;gap:36px;align-items:center}
...
/* ===== LOGIN CARD ===== */
.login-shell{max-width:468px;width:100%;justify-self:end}.login-card{background:linear-gradient(145deg,rgba(16,19,29,.94),rgba(9,12,20,.94));border:1px solid var(--border);border-radius:28px;padding:34px;box-shadow:0 28px 70px rgba(0,0,0,.34);position:relative;overflow:hidden}.login-card::before{content:'';position:absolute;top:-45%;right:-30%;width:420px;height:420px;background:radial-gradient(circle,rgba(34,211,238,.12),transparent 62%);pointer-events:none}.login-card::after{content:'';position:absolute;left:0;right:0;top:0;height:1px;background:linear-gradient(90deg,transparent,rgba(96,165,250,.45),transparent)}
...
<nav class="nav" id="nav">
  <div class="nav-in">
    ...
    <div class="nav-m">
      <a href="index.jsp#mkt" class="nav-a">Explore</a>
      <a href="index.jsp#how" class="nav-a">How it Works</a>
      <a href="index.jsp#cat" class="nav-a">Categories</a>
      <a href="index.jsp#feat" class="nav-a">Why Us</a>
      <a href="index.jsp#faq" class="nav-a">FAQ</a>
    </div>
    <div class="nav-r">
      <a href="clientLogin" class="btn-o">Client Login</a>
      <a href="freelancerRegister" class="btn-p">Create Account</a>
    </div>
...
<div class="mob" id="mob">
  <div class="mob-p">
    ...
    <a href="index.jsp#mkt">Explore</a>
    <a href="index.jsp#how">How it Works</a>
    <a href="index.jsp#cat">Categories</a>
    <a href="index.jsp#feat">Why Us</a>
    <a href="index.jsp#faq">FAQ</a>
    <div class="mob-b">
      <a href="clientLogin" class="btn-o" style="text-align:center;justify-content:center">Client Login</a>
      <a href="freelancerRegister" class="btn-p" style="text-align:center;justify-content:center">Create Account</a>
    </div>
  </div>
</div>
...
<main class="auth-page">
  <div class="wrap auth-grid">
    <section class="left-copy rv">
      <div class="pill"><i class="fa-solid fa-sparkles"></i> Freelancer workspace access</div>
      <h1>Find serious <em>client projects</em> and grow your career</h1>
      <p>Sign in to explore open projects, submit proposals, track assigned work, upload deliverables, and manage your freelance workflow inside WorkSphere.</p>

      <div class="mini-proof">
        <div class="proof-card rv d1"><i class="fa-solid fa-magnifying-glass-chart"></i><h5>Explore projects</h5><span>Browse client requirements and find work that matches your skills.</span></div>
        <div class="proof-card rv d2"><i class="fa-solid fa-paper-plane"></i><h5>Send proposals</h5><span>Apply with pricing, timelines, and a professional project pitch.</span></div>
        <div class="proof-card rv d3"><i class="fa-solid fa-upload"></i><h5>Submit work</h5><span>Deliver files, handle revisions, and complete assigned projects.</span></div>
      </div>

      <div class="market-row rv d2">
        <span><i class="fa-solid fa-shield-halved"></i>Verified clients</span>
        <span><i class="fa-solid fa-briefcase"></i>Real projects</span>
        <span><i class="fa-solid fa-chart-line"></i>Career growth</span>
      </div>
    </section>
    ...
    <section class="login-shell rv d1">
      <div class="login-card">
        <div class="card-head">
          <div class="card-tag"><i class="fa-solid fa-lock"></i> Freelancer Login</div>
          <h2>Welcome back</h2>
          <p>Continue to your dashboard and manage your freelance work pipeline.</p>
        </div>

        <form action="freelancerLogin" method="post" id="loginForm" novalidate>
          ...
          <div class="form-line">
            ...
            <a href="freelancerForgotPassword" class="small-link">Forgot password?</a>
          </div>
        ...
        <div class="signup-box">
          ...
          <a href="freelancerRegister">Create freelancer account <i class="fa-solid fa-arrow-right" style="font-size:10px;margin-left:3px"></i></a>
        </div>
      </div>
...
(function(){
  ...
  var mob=document.getElementById('mob'),mbtn=document.getElementById('mbtn'),mobx=document.getElementById('mobx');
  if(mbtn && mob){
  ...
  if(mob){ mob.addEventListener('click',function(e){ if(e.target===mob) closeMob(); }); }
  document.querySelectorAll('.mob-p a').forEach(function(a){ a.addEventListener('click',closeMob); });
