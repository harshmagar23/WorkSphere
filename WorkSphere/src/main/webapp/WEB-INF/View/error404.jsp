...
<title>Page Not Found | WorkSphere</title>
...
<main class="shell">
    <section class="copy">
        ...
        <h1>Page not found <em>404</em></h1>

        <p>The page you are looking for does not exist, was moved, or the route is not available in the current WorkSphere module.</p>
    ...
    <section class="card">
        ...
        <div class="info-grid">
            <div class="info">
                ...
                The page you are looking for does not exist, was moved, or the route is not available in the current WorkSphere module.
            </div>
