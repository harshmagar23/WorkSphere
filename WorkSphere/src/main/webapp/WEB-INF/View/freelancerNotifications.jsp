...
<title>Freelancer Notifications | WorkSphere</title>
...
<nav class="ws-nav" id="navbar">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="freelancerNotifications" class="active">Notifications</a>
    </div>
...
<main class="page">
    ...
    <div class="wrap">
      <div class="hero-grid">
        <div class="hero-copy reveal">
          <div class="kicker"><i class="fa-solid fa-bell"></i> Freelancer notification center</div>
          <h1>Track important <em>client updates</em> in one clean inbox</h1>
          <p>
            Stay updated with proposal changes, accepted bids, project movement, and important freelancer account alerts.
          </p>
        ...
        <aside class="alert-snapshot zoom-reveal d1">
          <div class="snapshot-top">
            <div>
              <h3>Freelancer alert workflow</h3>
              <p>Use notifications to react faster when clients interact with your work.</p>
            </div>
          ...
          <div class="snapshot-list">
            <div class="snapshot-item">
              ...
              <div><strong>Check new alerts</strong><span>Review proposal or project updates quickly.</span></div>
              <i class="fa-solid fa-arrow-right"></i>
            </div>
            <div class="snapshot-item">
              <div class="snapshot-num">02</div>
              <div><strong>Take action</strong><span>Move to proposals, assigned work, or profile tasks.</span></div>
              <i class="fa-solid fa-arrow-right"></i>
            </div>
            <div class="snapshot-item">
              <div class="snapshot-num">03</div>
              <div><strong>Stay responsive</strong><span>Fast response improves client trust.</span></div>
              <i class="fa-solid fa-arrow-right"></i>
            </div>
          </div>
        </aside>
      ...
      <div class="summary-grid zoom-reveal d2">
        <div class="summary-cell">
          ...
          <div class="summary-note">All notifications currently available for your freelancer account.</div>
        </div>
        <div class="summary-cell">
          <div class="summary-label">Primary Focus</div>
          <div class="summary-value"><i class="fa-solid fa-bell"></i></div>
          <div class="summary-note">Proposal decisions, project updates, and client activity.</div>
        </div>
        <div class="summary-cell">
          <div class="summary-label">Next Step</div>
          <div class="summary-value"><i class="fa-solid fa-reply"></i></div>
          <div class="summary-note">Open the relevant page and respond professionally.</div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="wrap">
      <div class="command-bar zoom-reveal">
        ...
        <div class="filter-tabs">
          ...
          <button type="button" class="filter-btn" data-filter="proposal">Proposal</button>
      ...
      <div class="inbox-shell">
        <div>
          ...
          <p class="section-copy reveal d1">A focused timeline of account updates, bid changes, and project activity from your freelancer workspace.</p>
          ...
          <div class="notification-list" id="notificationList">
            ...
            if(notifications != null && !notifications.isEmpty()){
                ...
                for(NotificationModel n : notifications){
                    ...
                    if(lowerMessage.contains("bid") || lowerMessage.contains("proposal") || lowerMessage.contains("accepted") || lowerMessage.contains("rejected")){
                        category = "proposal";
                        icon = "fa-paper-plane";
                    }else if(lowerMessage.contains("project") || lowerMessage.contains("work") || lowerMessage.contains("submitted") || lowerMessage.contains("completed")){
                        category = "project";
                ...
                <div class="note-row">
                  ...
                  <div class="note-content">
                    <div class="note-label">
                      ...
                      <%= "proposal".equals(category) ? "Proposal Update" : ("project".equals(category) ? "Project Update" : "New Update") %>
                    </div>
            ...
            %>
              <div class="empty-state zoom-reveal">
                ...
                <p>When clients respond to your bids or your projects get updated, alerts will appear here.</p>
                <a href="freelancerDashboard" class="action-main"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</a>
              </div>
            <%
            }
            %>
        ...
        <aside class="side-panel reveal d2">
          <div class="side-card">
            <h3 class="side-title">Response checklist</h3>
            <p class="side-copy">When you receive an alert, check what action is needed before moving forward.</p>
            <div class="check-list">
              <div><i class="fa-solid fa-check"></i><span>If a bid is accepted, open assigned projects and start delivery.</span></div>
              <div><i class="fa-solid fa-check"></i><span>If a proposal changes, update your next pitch strategy.</span></div>
              <div><i class="fa-solid fa-check"></i><span>If project work is requested, respond with clear status updates.</span></div>
            </div>
          </div>
          ...
          <div class="side-card">
            ...
            <div class="quick-links">
              <a href="myProposals"><span>My Proposals</span><i class="fa-solid fa-arrow-right"></i></a>
              ...
              <a href="viewFreelancerProfile"><span>My Profile</span><i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="side-card">
            ...
            <p class="side-copy" style="margin-bottom:0">
              Treat notifications like a response queue. Faster, clearer responses help clients trust your workflow.
            </p>
          </div>
        </aside>
      </div>
  ...
  <footer class="ws-footer">
    <div class="footer-grid">
      ...
      <div class="footer-note">Freelancer Notifications • 2026</div>
    </div>
  </footer>
</main>
