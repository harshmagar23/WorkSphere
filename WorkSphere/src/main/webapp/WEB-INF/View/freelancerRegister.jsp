...
<title>Freelancer Registration - WorkSphere</title>
...
.login-shell{max-width:720px;width:100%;justify-self:end}.login-card{background:linear-gradient(145deg,rgba(16,19,29,.94),rgba(9,12,20,.94));border:1px solid var(--border);border-radius:28px;padding:34px;box-shadow:0 28px 70px rgba(0,0,0,.34);position:relative;overflow:hidden}.login-card::before{content:'';position:absolute;top:-45%;right:-30%;width:420px;height:420px;background:radial-gradient(circle,rgba(34,211,238,.12),transparent 62%);pointer-events:none}.login-card::after{content:'';position:absolute;left:0;right:0;top:0;height:1px;background:linear-gradient(90deg,transparent,rgba(96,165,250,.45),transparent)}
...
<main class="auth-page">
  <div class="wrap auth-grid">
    <section class="left-copy rv">
      <div class="pill"><i class="fa-solid fa-sparkles"></i> Freelancer workspace setup</div>
      <h1>Create your <em>freelancer profile</em> with confidence</h1>
      <p>Register to showcase your skills, receive real project opportunities, submit proposals, deliver work, and build your freelance career inside one professional WorkSphere workflow.</p>

      <div class="mini-proof">
        <div class="proof-card rv d1"><i class="fa-solid fa-briefcase"></i><h5>Find projects</h5><span>Explore real client work across development, design, marketing, content, and more.</span></div>
        <div class="proof-card rv d2"><i class="fa-solid fa-paper-plane"></i><h5>Send proposals</h5><span>Apply with your skills, portfolio, experience, and pricing details.</span></div>
        <div class="proof-card rv d3"><i class="fa-solid fa-circle-check"></i><h5>Deliver work</h5><span>Submit completed work, handle revisions, and grow your professional reputation.</span></div>
      </div>

      <div class="market-row rv d2">
        <span><i class="fa-solid fa-shield-halved"></i>Verified clients</span>
        <span><i class="fa-solid fa-bolt"></i>Fast bidding</span>
    ...
    <section class="login-shell rv d1">
      <div class="login-card">
        <div class="card-head">
          <div class="card-tag"><i class="fa-solid fa-user-plus"></i> Freelancer Registration</div>
          <h2>Build your freelancer profile</h2>
          <p>Enter your details to create your WorkSphere freelancer account.</p>
        </div>

        <form action="${pageContext.request.contextPath}/saveFreelancer" method="post" id="registerForm">
          <div class="form-grid">
            ...
            <div class="input-wrap full">
              ...
              <div class="input-box">
                ...
                <input name="skills" type="text" placeholder="Java, Spring MVC, UI Design, SEO...">
              </div>
            </div>
            ...
            <div class="input-wrap">
              ...
              <div class="input-box">
                ...
                <input name="experience" type="text" placeholder="Example: 2">
              </div>
            </div>
            ...
            <div class="input-wrap">
              ...
              <div class="input-box">
                <i class="fa-solid fa-money-bill field-icon"></i>
                <input name="hourlyRate" type="text" placeholder="Example: 500">
              </div>
            </div>
            ...
            <div class="input-wrap">
              ...
              <div class="input-box">
                ...
                <input name="portfolio" type="text" placeholder="https://yourportfolio.com">
              </div>
            </div>
            ...
            <div class="input-wrap">
              ...
              <div class="input-box">
                <i class="fa-brands fa-github field-icon"></i>
                <input name="github" type="text" placeholder="GitHub profile link">
              </div>
            </div>
            ...
            <div class="input-wrap">
              ...
              <div class="input-box">
                ...
                <input name="linkedin" type="text" placeholder="LinkedIn profile link">
              </div>
            </div>
            ...
            <div class="input-wrap full">
              ...
              <div class="input-box textarea">
                ...
                <textarea name="bio" placeholder="Write a short professional bio"></textarea>
              </div>
            </div>
          </div>

          <button type="submit" class="login-btn">Create freelancer account <i class="fa-solid fa-arrow-right" style="font-size:12px;margin-left:6px"></i></button>
        </form>

        <div class="signup-box">
          <span>Already have an account?</span>
          <a href="${pageContext.request.contextPath}/freelancerLogin">Sign in <i class="fa-solid fa-arrow-right" style="font-size:10px;margin-left:3px"></i></a>
        </div>
      </div>
