...
<title>Client Forgot Password | WorkSphere</title>
...
<div class="auth-shell">
  ...
  <section class="brand-panel">
    ...
    <div class="hero-copy">
      <div class="kicker"><i class="fa-solid fa-user-tie"></i> Client Recovery</div>
    ...
    <div class="trust-row">
      ...
      <div class="trust-item">
        ...
        <span>Reset and continue to post projects and review proposals.</span>
      </div>
    </div>
  </section>
  ...
  <section class="form-panel">
    <div class="form-card">
      <div class="form-content">
        <div class="role-pill"><i class="fa-solid fa-user-tie"></i> Client Recovery</div>

        <h2>Recover your account.</h2>
        <p class="sub">Enter your registered client email. If it exists, we will open the secure reset screen.</p>
        ...
        <form action="clientCheckEmail" method="post">
          ...
          <div class="input-group-x">
            ...
            <div class="help">Use the same email you used during client registration.</div>
          </div>
        ...
        <div class="link-row">
          <span>Remember your password?</span><a href="clientLogin">Back to login</a>
          <a href="clientRegister">Create new account</a>
        </div>
