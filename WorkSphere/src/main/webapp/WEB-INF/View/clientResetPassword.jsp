...
<title>Client Reset Password | WorkSphere</title>
...
<div class="auth-shell">
  ...
  <section class="brand-panel">
    ...
    <div class="hero-copy">
      <div class="kicker"><i class="fa-solid fa-user-tie"></i> Client Password Reset</div>
  ...
  <section class="form-panel">
    <div class="form-card">
      <div class="form-content">
        <div class="role-pill"><i class="fa-solid fa-user-tie"></i> Client Password Reset</div>
        ...
        <form action="clientResetPassword" method="post" id="resetForm">
        ...
        <div class="link-row">
          <span>Reset complete?</span><a href="clientLogin">Go to login</a>
